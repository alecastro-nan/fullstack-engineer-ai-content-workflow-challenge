...
describe('CreateContentModal', () => {
  it('does not render when open is false', () => {
    render(
      <CreateContentModal open={false} onClose={vi.fn()} onCreate={vi.fn()} />,
    );
  ...
  it('renders form fields when open is true', () => {
    render(
      <CreateContentModal open={true} onClose={vi.fn()} onCreate={vi.fn()} />,
    );
  ...
  it('calls onCreate with headline and description', async () => {
    ...
    const user = userEvent.setup();
    render(
      <CreateContentModal open={true} onClose={vi.fn()} onCreate={onCreate} />,
    );
  ...
  it('calls onClose when cancel is clicked', async () => {
    ...
    const user = userEvent.setup();
    render(
      <CreateContentModal open={true} onClose={onClose} onCreate={vi.fn()} />,
    );
